						...
						<label style="color:red"><b>Invalid asset</b></label>
                                    <form role="form"  action="php/text_html.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Please Enter Original Value" name = "valueInput" type="number"/>
                                        </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Please Enter Location ID" name ="locationIDInput" required="required" type="number"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Select A Location</label>
                                            <select class="form-control" name="locationInput">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="statusInput" required="required">
                                             
                                                
                                                <option value="0">NEW ITEM</option>
                                                <option value="1">ITD STOCK</option>
                                                <option value="2">IN TRANSIT</option>
                                                <option value="3">IN USE</option>
                                                <option value="4">REPAIR</option>
                                                <option value="5">PENDING DISPOSAL</option>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="importantInput" id="optionsRadios1" value="1" checked />TRUE
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="importantInput" id="optionsRadios2" value="0"/>FALSE
                                                </label>
                                            </div>
